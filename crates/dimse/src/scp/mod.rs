...
pub use query_provider::DefaultQueryProvider;
...
impl DimseScp {
    ...
    pub(crate) async fn handle_association(
        &self,
        stream: tokio::net::TcpStream,
        peer_addr: SocketAddr,
    ) -> Result<()> {
        association::handle_association(self, stream, peer_addr).await
    }
